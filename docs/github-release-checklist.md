...
- `python3 -m unittest discover -v` 通过，当前 182 个测试。
...
- `bash scripts/verify_release.sh` 可一键执行脚本语法检查、全部 Python 脚本编译、发布包内容审计、临时 release zip 审计、单元测试、核心 JSON 样例、公开 CSV 最小闭环、覆盖审计和质量审计。
